...
|---|---:|---|
| `hopper_export_metadata.py` | 1.5.0 | Export segments, sections, strings, procedures, locals, tags, and CFG metadata from Hopper |
| `hopper_export_callgraph.py` | 1.5.0 | Export a procedure call graph with call-site and call-type metadata |
| `hopper_export_rust_analysis.py` | 1.5.0 | Export Rust-oriented function data with demangling, signatures, and call metadata |
| `hopper_apply_annotations.py` | 1.5.0 | Apply labels, comments, tags, colors, and bookmarks back into the current Hopper document |
| `enrich_hopper_exports.py` | 1.5.0 | Merge Hopper exports into enriched JSON while preserving richer call metadata |
...
| `prompt_pack/` | 1.5.0 | Reusable prompts for architecture reconstruction, security triage, flow mapping, and annotation generation |
